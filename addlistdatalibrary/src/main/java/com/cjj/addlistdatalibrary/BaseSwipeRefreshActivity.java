 ...
 * 说明 下拉刷新界面的基类
 */
public abstract class BaseSwipeRefreshActivity<T>
    ...
    private void initContentView() {
        mContentView = LayoutInflater.from(this).inflate(R.layout.base_swiperefresh, null);
        ...
        mTipInfo = (TipInfoLayout) mContentView.findViewById(R.id.tip_info);
     ...
     * @param map
     */
    public void dataProject(BaseRequest request, Map<String, String> map) {
        datas = null;
    ...
    public abstract void setListView(View mContentView);

    public abstract CommonAdapter<T> getAdapter();

    public abstract List<T> getData(String json);
