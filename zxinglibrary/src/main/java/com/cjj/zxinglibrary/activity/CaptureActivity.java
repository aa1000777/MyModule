...
import com.cjj.base.DialogHelp;
import com.cjj.base.StringUtils;
import com.cjj.zxinglibrary.R;
import com.cjj.zxinglibrary.camera.CameraManager;
import com.cjj.zxinglibrary.decode.DecodeThread;
import com.cjj.zxinglibrary.utils.BeepManager;
import com.cjj.zxinglibrary.utils.CaptureActivityHandler;
import com.cjj.zxinglibrary.utils.InactivityTimer;
...
public final class CaptureActivity extends BaseActivity implements
    ...
    private void showUrlOption(final String url) {
        ...
        DialogHelp.getConfirmDialog(this, "可能存在风险，是否打开链接?\n" + url, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                URLUtils.parseUrl(CaptureActivity.this, url);
                finish();
            }
    ...
    private void showUrlRedirect(String url) {
    ...
    private void showCopyTextOption(final String text) {
        DialogHelp.getConfirmDialog(this, text, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                cbm.setText(text);
                Toast.makeText(CaptureActivity.this,"复制成功",Toast.LENGTH_LONG);
                finish();
            }
        }, new DialogInterface.OnClickListener() {
            @Override
